...
const nonstopBtn = document.querySelector("#non-stop");
...
// function with the time on the landing page or should i put on the landing page with<script>???
...
startBtn.addEventListener('click', () => {
  ...
  // still to finish
  nonstopBtn.addEventListener('click', () => {
    clearInterval(countdown);
  });
